/* Ancestry Atlas v3.7.2 — complete tour routing with direct-film and mirrored-TV paths. */
(()=>{
  'use strict';
  ...
  function showViewingChoice(track){
    ...
    if($('tourWatchTV')){
      $('tourWatchTV').hidden=false;
      $('tourWatchTV').textContent=completedFilm?'Play on Television':'Present on Television';
    }
