...
(()=>{
  ...
  if(john){
    ...
    john.status='approved-audio-archived-runtime-ready';
    john.storyReady=true;
    john.audio='approved-audio/fable/John_peter_gooley.mp3';
    john.narrator='Fable';
    john.unavailableLabel='Approved Fable narration is temporarily unavailable';
    john.narrationContract='approved v3.8.19 text; matching checksummed Fable recording is timing authority';
  ...
  if(mary){
    ...
    mary.status='approved-audio-archived-runtime-ready';
    mary.storyReady=true;
    mary.audio='approved-audio/fable/Mary_ann_dennis.mp3';
    mary.narrator='Fable';
    mary.unavailableLabel='Approved Fable narration is temporarily unavailable';
    mary.narrationContract='approved v3.8.19 text; matching checksummed Fable recording is timing authority';
