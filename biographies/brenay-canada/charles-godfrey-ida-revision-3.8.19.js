...
(()=>{
  ...
  if(godfrey){
    ...
    godfrey.status='revised-text-awaiting-audio-approval';
    godfrey.storyReady=true;
    godfrey.audio=null;
    godfrey.narrator=null;
    godfrey.unavailableLabel='Revised narration awaiting Fable recording';
  ...
  if(ida){
    ...
    ida.status='revised-text-awaiting-audio-approval';
    ida.storyReady=true;
    ida.audio=null;
    ida.narrator=null;
    ida.unavailableLabel='Revised narration awaiting Fable recording';
